...
//Date : 1-31-99
//Assignment: 2 for the 15a lab
//Problem Description: Create an applet that draws a circle and when the applet
//is redrawn the circle changes color from red to black and back again
//*****************************************************************************
...
//This class is creates an applet which will display a circle that changes color 
...
public class DrawACircle extends Applet
{
	...
	//this function is called each time the applet must be repainted 
	//because of an event like a window or cursor being moved over the 
	//applet
	...
	public void paint(Graphics g)
	{
		...
		y=(int)(myCircle.ComputeY((double)degrees/180*3.14)*24+25);

			//draw a line from previos end point to next point
